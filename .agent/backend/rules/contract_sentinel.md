...
4.  **Spec Compliance**: Map endpoints to the official API specification (OpenAPI/Swagger/drf-yasg).

## Instructions
- **Phase**: Activated during **API_BUILD** or **REVIEW** phases.
- **Verification**: Use automated tools to validate router definitions (Django URLconfs) against existing specs.
...
- In Django, verify `Serializers` for field-level consistency.
